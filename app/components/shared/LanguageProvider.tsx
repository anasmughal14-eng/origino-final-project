...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "nav.signIn": "Sign In",
    "lang.urdu": "اردو",
    "footer.tagline": "Pakistan's Finest Export Marketplace",
    "footer.body": "Connecting the world's buyers with Pakistan's master craftsmen. Curated. Verified. Trusted.",
    ...
    "footer.marketplaceLine": "Pakistan's First Curated B2B Export Marketplace",
    ...
    "clusters.title": "Five Cities. One Nation's Export Legacy.",
    "clusters.description": "Pakistan's manufacturing excellence is concentrated in five extraordinary industrial clusters, each world-class in its own right.",
