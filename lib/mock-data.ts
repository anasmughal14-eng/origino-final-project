...
export const mockPageSections: PageSection[] = [
  {
    ...
    created_at: now,
    content: {
      eyebrow: "Pakistan Export Marketplace",
      eyebrow_ur: "پاکستان ایکسپورٹ مارکیٹ پلیس",
      title: "Source from verified Pakistani manufacturers.",
      title_ur: "تصدیق شدہ پاکستانی مینوفیکچررز سے سورس کریں۔",
      description: "ORIGINO connects global buyers with export-ready suppliers across Sialkot, Faisalabad, Lahore, Karachi, and Gujranwala.",
